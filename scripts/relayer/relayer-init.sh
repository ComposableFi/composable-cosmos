...
$BINARY chains add-dir ./scripts/relayer/chains --home $CHAIN_DIR/$RELAYER_DIR
$BINARY paths add $CHAINID_1 $CHAINID_2 test1-test2 --file ./scripts/relayer/paths/test1-test2.json --home $CHAIN_DIR/$RELAYER_DIR
