...
#osmosisd start --pruning=nothing  --minimum-gas-prices=0stake --p2p.laddr tcp://0.0.0.0:4240 --rpc.laddr tcp://0.0.0.0:4241 --grpc.address 0.0.0.0:4242 --grpc-web.address 0.0.0.0:4243
osmosisd start
