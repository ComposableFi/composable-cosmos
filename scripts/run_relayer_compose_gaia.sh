...
hermes --config scripts/relayer_hermes/config_compose_gaia.toml keys delete --chain centaurid-t1 --all
hermes --config scripts/relayer_hermes/config_compose_gaia.toml keys add --chain centaurid-t1 --mnemonic-file scripts/relayer_hermes/alice.json
