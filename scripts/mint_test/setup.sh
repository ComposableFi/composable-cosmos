...
ESCROW_ADDRESS=$(centaurid q transfermiddleware escrow-address channel-0)
...
sleep 20
balancesEscrowAdress = $(centaurid query bank balances $ESCROW_ADDRESS)

centaurid 

centaurid tx ibc-transfer transfer transfer channel-0 cosmos1hce8cea32gjg9eaqzxj02jrgc6m6q59wly4zpm 
