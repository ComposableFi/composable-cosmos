...
func NewCentauriApp(
	...
	*/
	...
	ratelimitMiddlewareStack := ratelimitmodule.NewIBCMiddleware(app.RatelimitKeeper, ibcMiddlewareStack)
	...
	ibcRouter.AddRoute(ibctransfertypes.ModuleName, ratelimitMiddlewareStack)
