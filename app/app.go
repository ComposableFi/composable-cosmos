...
import (
	...
	centauriupgradev3 "github.com/notional-labs/centauri/v3/app/upgrade/v3"
...
func NewCentauriApp(
	...
	*/
	...
	app.UpgradeKeeper.SetUpgradeHandler("v3", centauriupgradev3.CreateUpgradeHandler(app.mm, app.configurator, app.keys, app.appCodec))
