...
require (
	...
	github.com/cosmos/ibc-go/modules/light-clients/08-wasm v0.0.0-20231221174622-947b15ed0e3d // indirect
...
replace (
	...
	// need to elinminate if possible (or understand then upgrade)
	...
	// use a locked known good version of goleveldb
